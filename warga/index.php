...
<body class="bg">
    ...
    <script>
        ...
        function displayToken(token) {
            ...
            // Coba auto-copy (akan berhasil jika browser izinkan)
            try {
                ...
                // fallback jika error, tidak mengganggu feedback
                console.warn('Auto-copy gagal', e);
            }
        }
